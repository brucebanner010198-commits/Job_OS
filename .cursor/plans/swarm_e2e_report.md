...
generated: 2026-09-21T19:16:22.850Z
db_available: true
---
...
| 4 | Job discovery (OSS sources) → scored queue | PASS | live | offline preview queue: 13 jobs; filtered audit: 6; DB ingest: 28 raw, 18 kept, queue=18; top job: Senior Independent AI Engineer / Architect @ A.Team score=0.2331168831168831 |
| 5 | Company brief generated with citations | PASS | offline | claims=10, refused=2; verified claims=7 |
| 6 | Tailor resume + cover letter for a job | PASS | fixture | resume provenance ok=true, cover provenance ok=true; saved resumeVersion=cmubmlxg… coverLetter=cmubmlxg… |
