...
generated: 2026-09-23T10:10:43.528Z
db_available: true
---
...
|------|---------|--------|------|-------|
| 1 | Upload/import master resume → ProfileEntry populated | PASS | live | live importResumeText added 3 entries; kinds: CONTACT, EXPERIENCE, SKILL |
| 2 | Voice dictation updates resume | PASS | live | live dictation extracted 2 entries |
| 3 | Career goals saved → scoring uses goals | PASS | live | saved northStar: VP of Engineering; EM job relevance manager=0.875 ml=0.125; queue top: no-goals=Senior Backend Engineer / with-goals=Senior Backend Engineer |
| 4 | Job discovery (OSS sources) → scored queue | PASS | live | offline preview queue: 13 jobs; filtered audit: 6; DB ingest: 28 raw, 20 kept, queue=20; top job: Senior Independent AI Engineer / Architect @ A.Team score=0.8059705642071823 |
| 5 | Company brief generated with citations | PASS | offline | claims=10, refused=2; verified claims=7 |
| 6 | Tailor resume + cover letter for a job | PASS | fixture | resume provenance ok=true, cover provenance ok=true; saved resumeVersion=cmudxzwy… coverLetter=cmudxzwy… |
